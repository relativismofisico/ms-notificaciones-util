package co.com.notificaciones.exception;
...
public class ExceptionManager {
     ...
     * exitosas
     *
     * @param e atributo del tipo MethodArgumentNotValidException usado para
     *          excepciones de validación (Utiliazadas en
     *          javax.validation.constraints y
    ...
    public ResponseEntity<Object> manageMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        if (messageSource == null) {
            ...
            mensaje = messageSource.getMessage(
                    "cl.bci.mscore.exceptionmanager.methodargumentnotvalid."
